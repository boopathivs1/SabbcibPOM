...
public class TC_57_Overseas_Transfer_SI  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC57 Overseas Transfer SI";
		testDescription="Overseas Transfer Standing Instruction - (Paylater to PayNow)";
		browserName="Chrome";
