...
public class TC_51_Local_Transfer_SI  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC51 Local Transfer SI";
		testDescription="Local Transfer Standing Instruction - (Repeat Update)";
		browserName="Chrome";
