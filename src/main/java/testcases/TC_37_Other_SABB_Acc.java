...
public class TC_37_Other_SABB_Acc   extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC37 Other SABB Account";
		testDescription="Payment Other SABB Pay Later";
		browserName="Chrome";
	...
	public void OtherSaabPayLater(String casename,String GroupID ,String Username,String Password,String Otp,String accno,String transfertype,String fromCompany,String fromacc,String ToBeneficiary,String currency,String amount,String Purpose,String foryouracc,String auth1,String auth2,String frequency,String timesofday,String data3,String data4,String data5) throws Exception{
...
//.vendorPayments_Payment_OtherSabbAcc(currency, amount,"Tomorrow","Pay Later", frequency, timesofday,Purpose,foryouracc);
	...
	.OwnPaymentFundTransferStatus(prop.getProperty("othersaab.acc.payreports.xpath"), "Pending Authorization","Pending Authorization","Tomorrow")
			...
			//	.OwnPaymentStatus(prop.getProperty("othersaab.acc.payreports.xpath"), "Pending Authorization","Pending Authorization","Tomorrow")
