...
public class TC_49_Local_Transfer_SI  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC49 Local Transfer Standing Instruction";
		testDescription="Local Transfer Standing Instruction - (Paylater to PayNow)";
		browserName="Chrome";
...
////.navigatepayreport()
//.clickPaymentReports()
//.PaymentStatus(prop.getProperty("localtransfer.xpath"), "Success","Success","Tomorrow")
