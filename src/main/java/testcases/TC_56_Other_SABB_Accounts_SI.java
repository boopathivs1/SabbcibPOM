...
public class TC_56_Other_SABB_Accounts_SI  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC56 Other SABB Accounts SI";
		testDescription="Other SABB Accounts Standing Instruction - (Repeat to SKIP)";
		browserName="Chrome";
