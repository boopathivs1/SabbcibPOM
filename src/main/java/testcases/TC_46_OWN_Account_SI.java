...
public class TC_46_OWN_Account_SI  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC46 OWN Account Standing Instruction";
		testDescription="OWN Account Standing Instruction - (Paylater Update)";
		browserName="Chrome";
