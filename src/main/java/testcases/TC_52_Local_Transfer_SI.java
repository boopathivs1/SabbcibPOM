...
public class TC_52_Local_Transfer_SI  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC52 Local Transfer SI";
		testDescription="Local Transfer Standing Instruction - (Repeat to SKIP)";
		browserName="Chrome";
