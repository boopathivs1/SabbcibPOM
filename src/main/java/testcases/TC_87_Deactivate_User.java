...
public class TC_87_Deactivate_User  extends ProjectWrapp
{
@BeforeClass(groups={"common"})
public void setDatag() {
	testCaseName="TC87 Deactivate User";
...
public void deactivateUser	(String casename,String GroupID ,String Username,String Password,String Otp,String userid,String auth1,String auth2,String groupname,String data1,String data11,String data12,String data13,String data14,String data15,String data16,String data17,String data18,String data19,String data20,String data21) throws Exception{	
...
.clickDeactivateuser(userid)
.clickDatelinemenu()
.verifyAdminbuzz(auth1,auth2, "Corporate User Profile De-Activation Request")
