...
public class TC_59_Overseas_Transfer_SI  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC59 Overseas Transfer SI";
		testDescription="Overseas Transfer Standing Instruction - (Repeat Update)";
		browserName="Chrome";
...
//.fillSIPayLaterToPayNow("RepeatUpdate")
