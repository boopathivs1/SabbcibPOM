...
public class TC_27_Other_SABB_Accounts  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC27 Other SABB Accounts";

		testDescription="Create Beneficiary - Other SABB Accounts";
		browserName="Chrome";
	...
	public void createBeneficiarOtherSABBAccounts(String casename,String GroupID ,String Username,String Password,String Otp,String CorpValue,String TransferValue,
			String sabbacc,String TransferPurpose,String Remarks,String auth1,String auth2,
			String saabaccno,String data4,String data5,String data6,String data7,String data8,String data10,String data11,String data12) throws Exception{
