...
public class TC_14_New_Deposit_Request   extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC14_New Deposit Request";
...
.statementpageBalance()
	...
	//acc
	.maturityOptionsNewDepositReinvestment("Reinvestment of investment amount only",Profiletransferto)
