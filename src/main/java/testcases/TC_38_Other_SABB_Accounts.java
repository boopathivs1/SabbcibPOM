...
public class TC_38_Other_SABB_Accounts  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC38 Other SABB Accounts";

		testDescription="Other SABB Accounts_Repeat";
		browserName="Chrome";
	...
	public void OtherSaabRepeat(String casename,String GroupID ,String Username,String Password,String Otp,String accno,String transfertype,String fromCompany,String fromacc,String ToBeneficiary,String currency,String amount,String Purpose,String foryouracc,String auth1,String auth2,String frequency,String timesofday,String data3,String data4,String data5) throws Exception{
