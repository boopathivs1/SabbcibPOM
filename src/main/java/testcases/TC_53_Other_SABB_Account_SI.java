...
public class TC_53_Other_SABB_Account_SI  extends ProjectWrapp {
	
	
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC53 Other SABB Accounts SI";
		testDescription="Other SABB Accounts Standing Instruction - (Paylater to PayNow)";
		browserName="Chrome";
...
//public OtP_Page fillSIPayLaterToPayNow(String transfermodeSelection,String foryouacc,String currencytype,String amount) throws InterruptedException{
...
//getrefnumer="STANDING_INSTRUCTION-20005";
