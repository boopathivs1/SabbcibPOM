...
public class TC_50_Local_Transfer_SI  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC50_Local Transfer SI ";
		testDescription="Local Transfer Standing Instruction - (Paylater Update)";
		browserName="Chrome";
