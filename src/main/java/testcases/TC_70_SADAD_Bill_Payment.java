...
public class TC_70_SADAD_Bill_Payment  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC70 SADAD Bill Payment";

		testDescription="SADAD Bill Inquiry and Payment (Multiple BIll Selection)";
		browserName="Chrome";
	...
	public void billInquiryMultiSelection(String casename,String GroupID ,String Username,String Password,String Otp,String accno,
			String amount,String corpno,String fromaccnum,String auth1,String auth2,String categorybillname,String billcompany,String datas3,String datas4,
...
.billInquirySingleMultiFilter(corpno, categorybillname, billcompany)
.billInquiryFormSubmit(amount,corpno,fromaccnum,"multicheckbox")
