...
public class TC_93_Matrix_Deletion  extends ProjectWrapp
{
@BeforeClass(groups={"common"})
public void setDatag() {
	testCaseName="TC93 Matrix Deletion";
...
.verifyMatrixNotPresent(functiondropdown,authtype).logout(LogoutStatus,usertype);
