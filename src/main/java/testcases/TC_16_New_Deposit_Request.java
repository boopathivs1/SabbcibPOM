...
public class TC_16_New_Deposit_Request   extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC16_New Deposit Request";

		testDescription="New Deposit Request [Commoditiy investment Account] with Maturity option -Full encashment of investment amount and profit.";
		browserName="Chrome";
...
.statementpageBalance()
	...
	//acc
	.maturityOptionsNewDepositReinvestment("Full encashment of investment amount and profit",Profiletransferto)
