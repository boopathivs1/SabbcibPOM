...
public class TC_96_Matrix_Modification  extends ProjectWrapp
{
@BeforeClass(groups={"common"})
public void setDatag() {
	testCaseName="TC96 Matrix Modification";

	testDescription="Matrix Modification - Sequential Auth  Multiple slab";	
	browserName="Chrome";
